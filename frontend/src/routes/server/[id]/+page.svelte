<script>
  ...
  const customDomains = {
      'jellyfin': 'https://lunkflix.jstowers1.dev',
      'wizarr': 'https://join.jstowers1.dev',
      'open-webui': 'https://ai.jstowers1.dev',
      'llama-swap': 'N/A',
      'adguardhome': 'https://adguard.jstowers1.dev',
      'lunkbot': 'N/A'
    }

  let connectionAddress = $derived(
      customDomains[server.id] || `play.jstowers1.dev:${server.client_port}`
  );
      ...
      <div class="bg-[#111827] p-4 rounded border border-gray-700/50 min-w-0">
        ...
        <div class="mt-2 pt-2 border-t border-gray-700/30">
          ...
          <div class="text-blue-300 font-mono text-sm break-words">
            play.jstowers1.dev:{bedrockPort}
          </div>
        </div>
        {/if}
      </div>
