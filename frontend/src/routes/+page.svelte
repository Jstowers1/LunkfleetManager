        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            {#if role === 'admin'}
                ...
                <div class="bg-[#111827] p-4 rounded-r-lg border-y border-r border-gray-700 border-l-4 border-l-purple-500">
                    ...
                    <p class="text-gray-300 text-sm text-wrap break-words">Here's the IP Address: <span class="font-mono text-purple-300"><VPS_PUBLIC_IP></span>. Only use SSH keys for access. Don't forget about sshm!</p>
                </div>
            {/if}
